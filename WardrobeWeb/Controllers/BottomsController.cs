...
namespace WardrobeWeb.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,BottomName,BottomStyle,BottomColor,BottomLength,BottomWaist,Image,BottomSeason,BottomOccasion")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,BottomName,BottomStyle,BottomColor,BottomLength,BottomWaist,Image,BottomSeason,BottomOccasion")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
